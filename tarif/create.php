...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $daya = $_POST['daya']; // Daya listrik
    $tarifperkwh = $_POST['tarifperkwh']; // Tarif per kWh
...
<head>
    ...
    <title>Form Buat Tarif Baru</title>
        ...
        <div class="body-wrapper">
            <div class="container-fluid">
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fw-semibold mb-4">Form Buat Tarif Baru</h5>
                            <div class="card">
                                <div class="card-body">
                                    <form method="POST" action="">
                                        ...
                                        <button type="submit" class="btn btn-primary">Buat Tarif</button>
                                    </form>
                                </div>
                            </div>
                        </div>

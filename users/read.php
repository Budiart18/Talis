...
// Query untuk mengambil data pengguna dan level akses
$sql = "SELECT u.*, l.nama_level FROM users u JOIN level l ON u.id_level = l.id_level";
                    ...
                    <div class="col-lg-12 d-flex align-items-stretch">
                        <div class="card w-100">
                            <div class="card-body p-4">
                                ...
                                <a href="create.php"><span class="badge bg-primary rounded-3 fw-semibold">Buat Baru Users</span></a>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="border-bottom-0">
                                                    <h6 class="fw-semibold mb-0"><?php echo $row['id_user']; ?>
                                                    </h6>
                                                </td>
                                                <td class="border-bottom-0">
                                                ...
                                                <td class="border-bottom-0">
                                                    <p class="mb-0 fw-normal"><?php echo $row['password']; ?></p>
                                                </td>
                                                <td class="border-bottom-0">
                                                    <p class="mb-0 fw-normal"><?php echo $row['nama_admin']; ?></p>
                                                </td>
                                                <td class="border-bottom-0">
                                                    <p class="mb-0 fw-normal"><?php echo $row['nama_level']; ?></p>
                                                </td>
                                                <td class="border-bottom-0">
